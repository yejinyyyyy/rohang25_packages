...
#include "frame.h"
    ...
    #define MISSION_ALT1 30
    #define MISSION_ALT2 30
    #define MISSION_RADIUS 15
    #define PTURN_RADIUS 35
    #define CIRCLE_DIRECTION CCW
...
std::vector<std::vector<double>> WPT = {
...
#elif MISSION_NUMBER == GWANGNARU
    // 008 
    {37.5468486, 127.1188457, MISSION_ALT1}, // base (WP#1)
    {37.5480004, 127.1192505, MISSION_ALT1}, // WPT#2
    {37.5488988, 127.1198594, MISSION_ALT1}, // WPT#3
    {37.5488126, 127.1183051, MISSION_ALT1}, // WPT#4
    {37.5480004, 127.1192505, MISSION_ALT1}, // WPT#5 
    {37.5469336, 127.1184652, MISSION_ALT1}, // WPT#6 - 구조위치
    {37.5470813, 127.1191247, MISSION_ALT1}, // WPT#7 - 하기위치
    {37.5468486, 127.1188457, MISSION_ALT1}  // base
    ...
    {35.0515885, 128.0395187, 5} // base (임시)

#elif MISSION_NUMBER == SACHEON //사천
    // 012
    {35.051674, 128.038923, MISSION_ALT1}, // WPT#1
    {35.051845, 128.037568, MISSION_ALT1}, // WPT#2
    {35.053682, 128.035687, MISSION_ALT1}, // WPT#3
    {35.050028, 128.034947, MISSION_ALT1}, // WPT#4
    {35.050692, 128.037352, MISSION_ALT1}, // WPT#5
    {35.051808, 128.039227, MISSION_ALT1}, // WPT#6 - 조난자
    {35.051551, 128.039171, MISSION_ALT1},  // WPT#7 - 하기지점
    {35.051551, 128.039171, MISSION_ALT1} // base
